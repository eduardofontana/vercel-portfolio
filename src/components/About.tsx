...
import { Shield, Cpu, Eye, Zap, type LucideIcon } from "lucide-react";
    ...
    <section id="about" className="relative min-h-screen overflow-hidden px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-6 lg:grid-cols-12 lg:gap-8">
        <motion.div
          ...
          viewport={{ once: true }}
          className="rounded-lg border border-border bg-bg-secondary/50 p-5 backdrop-blur-sm sm:p-6 md:p-8 lg:col-span-7"
        >
        ...
        >
          <div className="rounded-lg border border-border bg-bg-secondary/50 p-5 backdrop-blur-sm sm:p-6">
            <div className="mb-6 flex items-center gap-2">
          ...
          >
            <div className="grid grid-cols-3 gap-4 text-center sm:gap-6">
              <div>
                <div className="text-2xl font-bold text-accent sm:text-3xl md:text-4xl">15+</div>
                <div className="mt-1 font-mono text-[10px] text-text-muted sm:text-xs">ANOS EXP</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-accent sm:text-3xl md:text-4xl">29+</div>
