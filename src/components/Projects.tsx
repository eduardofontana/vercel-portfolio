    ...
    <section id="projects" className="relative min-h-screen overflow-hidden py-20 sm:py-24">
      ...
      {loading ? (
        ...
        <div className="relative px-4 pb-8 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-2 xl:grid-cols-3 xl:gap-6">
                ...
                >
                  ...
                  <div className="flex h-full flex-col p-4 sm:p-5 md:p-6">
                    <div className="mb-4 flex items-start justify-between gap-4">
                      <motion.span
                        className="text-4xl font-bold text-border sm:text-5xl md:text-6xl"
                        animate={{
                    ...
                    <motion.h3
                      className="mb-3 text-lg font-bold sm:text-xl md:text-2xl"
                      animate={{
                        textShadow:
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.stack.map((tag, j) => (
                          <motion.span
                            ...
                            viewport={{ once: true }}
                            className="rounded border border-border px-3 py-1 text-[11px] font-mono text-text-secondary transition-colors hover:border-accent hover:text-accent sm:text-xs"
                          >
                            {tag}
                          </motion.span>
                        ))}
